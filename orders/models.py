...
class Order(models.Model):
    ...
    order_number = models.CharField(max_length=20, unique=True)  # Ensuring unique order numbers
    ...
    ip = models.GenericIPAddressField(blank=True, null=True)  # Improved IP field
